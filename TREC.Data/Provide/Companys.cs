...
namespace TREC.Data
{
    public class Companys
    {
        ...
        public static int ExitComapny(string title)
        {
            SqlParameter[] parames = { 
            new SqlParameter("@title", SqlDbType.NVarChar, 30)};
            parames[0].Value = title;
            return DataCommon.Exists(TableName.TBCompany, " where title=@title", parames);
        }

        public static EnWebCompany GetWebCompanyInfo(string strWhere)
        {
            return GetWebCompanyInfo(strWhere, false);
        }
        public static EnWebCompany GetWebCompanyInfo(string strWhere, bool IsCache)
        {
            EnWebCompany model = new EnWebCompany();
            string cachename = "company" + strWhere.Trim().Replace(" ", "").ToLower();
            if (IsCache)
            {
                model = (EnWebCompany)DataCache.GetCache(cachename);
                if (model != null)
                {
                    return model;
                }
            }
            model = new EnWebCompany();
            IDataReader reader = DataCommon.GetDataIReader(TableName.TVCompanyList, "", strWhere, "");
            while (reader.Read())
            {
                ...
                if (reader["productxml"] != null && reader["productxml"].ToString() != "")
                {
                    model.productxml = reader["productxml"].ToString();
                }
                if (reader["certifyxml"] != null && reader["certifyxml"].ToString() != "")
                {
                    model.certifyxml = reader["certifyxml"].ToString();
                }
            ...
            if (model != null && IsCache)
            {
                DataCache.SetCache(cachename, model, DateTime.Now.AddMinutes(5), TimeSpan.Zero);
            }
            return model;
        }
        ...
        {
            List<EnWebCompany> list = new List<EnWebCompany>();
            IDataReader reader = DataCommon.GetPageDataReader(TableName.TVCompanyList, PageIndex, PageSize, strWhere, sortkey, orderType, out pageCount);
            while (reader.Read())
            {
                EnWebCompany model = new EnWebCompany();
                if (reader["brandxml"] != null && reader["brandxml"].ToString() != "")
        ...
        {
            List<EnWebCompanyBrand> list = new List<EnWebCompanyBrand>();
            IDataReader reader = DataCommon.GetPageDataReader(TableName.TVCompanyBrandList, PageIndex, PageSize, strWhere, sortkey, ordertype, out pageCount);
            while (reader.Read())
            {
                EnWebCompanyBrand model = new EnWebCompanyBrand();
                if (reader["id"] != null && reader["id"].ToString() != "")
                {
                    model.id = int.Parse(reader["id"].ToString());
                }
                ...
                if (reader["brandthumb"] != null && reader["brandthumb"].ToString() != "")
                {
                    model.brandthumb = reader["brandthumb"].ToString();
                }
                if (reader["bthumb"] != null && reader["bthumb"].ToString() != "")
                {
                    model.bthumb = reader["bthumb"].ToString();
                }
                ...
                if (reader["spreadvalue"] != null && reader["spreadvalue"].ToString() != "")
                {
                    model.spreadvalue = reader["spreadvalue"].ToString();
                }
                if (reader["brandlinestatus"] != null && reader["brandlinestatus"].ToString() != "")
                {
                    model.brandlinestatus = int.Parse(reader["brandlinestatus"].ToString());
                }
                list.Add(model);
            }
            reader.Close();
        ...
        //企业搜索选项
        public static List<EnSearchItem> GetCompanySearchItem()
        {
            List<EnSearchItem> list = new List<EnSearchItem>();
            IDataReader reader = DbHelper.ExecuteReader(" select * from " + TableName.TVCompanySearchItem);
            while (reader.Read())
            {
        ...
        public static int EditCompany(EnCompany model)
        {
            if (model.id == 0)
            {
                ...
                SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@license",SqlDbType.VarChar,100),
                    new SqlParameter("@registration",SqlDbType.VarChar,100),
                    new SqlParameter("@brandInfo",SqlDbType.NVarChar,200),
                    new SqlParameter("@organization",SqlDbType.VarChar,100),
                    new SqlParameter("@QQWeiBo",SqlDbType.VarChar,100),
                ...
                parameters[41].Value = model.license;
                parameters[42].Value = model.registration;
                parameters[43].Value = model.BrandInfo;
                parameters[44].Value = model.organization;
                parameters[45].Value = model.QQWeiBo;
                parameters[46].Value = model.Duty;
            ...
            else
            {
                ...
                strSql.Append("QQWeiBo=@QQWeiBo,Duty=@Duty,cPerson=@cPerson,ContactType=@ContactType,brandInfo=@brandInfo");
                ...
                SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@cPerson",SqlDbType.NVarChar,20),
                    new SqlParameter("@ContactType",SqlDbType.NVarChar,500),
                    new SqlParameter("@brandInfo",SqlDbType.NVarChar,200)
                };
                parameters[0].Value = model.mid;
                parameters[1].Value = model.title;
                ...
                parameters[42].Value = model.license;
                parameters[43].Value = model.registration;
                parameters[44].Value = model.organization;
                parameters[45].Value = model.QQWeiBo;
                parameters[46].Value = model.Duty;
                parameters[47].Value = model.cPerson;
                parameters[48].Value = model.ContactType;
                parameters[49].Value = model.BrandInfo;
        ...
        {
            string sql = " SELECT TOP 1 id,title," + companyId + " AS companyid FROM t_promotions WHERE membertype=103 AND mid IN(  SELECT mid FROM t_company WHERE id=" + companyId + ") ORDER BY id desc ";
        ...
        public static EnCompany GetCompanyInfo(string strWhere)
        {
            ...
            if (reader.Read())
            {
                ...
                if (reader["license"] != null && reader["license"].ToString() != "")
                {
                    model.license = reader["license"].ToString();
                }
                if (reader["registration"] != null && reader["registration"].ToString() != "")
                {
                    model.registration = reader["registration"].ToString();
                }
                if (reader["organization"] != null && reader["organization"].ToString() != "")
                {
                    model.organization = reader["organization"].ToString();
                }

                //QQ/微博 	
                if (!(reader["QQWeiBo"] is DBNull))
                    model.QQWeiBo = reader["QQWeiBo"].ToString();
                //职位
                if (!(reader["Duty"] is DBNull))
                    model.Duty = reader["Duty"].ToString();
                //负责人
                if (!(reader["cPerson"] is DBNull))
                    model.cPerson = reader["cPerson"].ToString();
                //联系方式
                if (!(reader["ContactType"] is DBNull))
                    model.ContactType = reader["ContactType"].ToString();
                //联系方式
                if (!(reader["BrandInfo"] is DBNull))
                    model.BrandInfo = reader["BrandInfo"].ToString();
                reader.Close();
                if (!reader.IsClosed)
                {
                    reader.Close();
        ...
        {
            List<EnCompany> modelList = new List<EnCompany>();
            DataTable dt = DataCommon.GetPageDataTable(TableName.TBCompany, PageIndex, PageSize, strWhere, "", 1, out pageCount);
            if (dt.Rows.Count > 0)
            {
                EnCompany model;
                for (int n = 0; n < dt.Rows.Count; n++)
                {
                    ...
                    if (dt.Rows[n]["registration"] != null && dt.Rows[n]["registration"].ToString() != "")
                    {
                        model.registration = dt.Rows[n]["registration"].ToString();
                    }
                    if (dt.Rows[n]["organization"] != null && dt.Rows[n]["organization"].ToString() != "")
                    {
                        model.organization = dt.Rows[n]["organization"].ToString();
                    }
                    modelList.Add(model);
                }
            }
        ...
        public static int EditCompanyGroup(EnCompanyGroup model)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into t_companygroup(");
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("update t_companygroup set ");
                strSql.Append("title=@title,");
        ...
        public static EnCompanyGroup GetCompanyGroupInfo(string strWhere)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  * from t_CompanyGroup ");
            strSql.Append(strWhere);


            EnCompanyGroup model = new EnCompanyGroup();
            IDataReader reader = DbHelper.ExecuteReader(CommandType.Text, strSql.ToString());
        ...
        {
            List<EnCompanyGroup> modelList = new List<EnCompanyGroup>();
            DataTable dt = DataCommon.GetPageDataTable(TableName.TBCompanyGroup, PageIndex, PageSize, strWhere, "", 1, out pageCount);
            if (dt.Rows.Count > 0)
            {
                EnCompanyGroup model;
                for (int n = 0; n < dt.Rows.Count; n++)
                {
        ...
        {
            List<EnCompany> modelList = new List<EnCompany>();
            DataTable dt = DataCommon.GetPageDataTable(TableName.TVAdminCompanyList, PageIndex, PageSize, strWhere, "", 1, out pageCount);
            if (dt.Rows.Count > 0)
            {
                EnCompany model;
                for (int n = 0; n < dt.Rows.Count; n++)
