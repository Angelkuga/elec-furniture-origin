...
namespace TREC.Entity
{
	...
	/// </summary>
	[Serializable]
    public partial class EnCompany
	{
        public EnCompany()
		{}
        #region Model
    ...
    public class t_company
    {
        ...
        /// 
        /// </summary>
        public const string TableName = "t_company";
        ...
        public const string Field_registration = "registration";
        ...
        public const string Field_QQWeiBo = "QQWeiBo";
        public const string Field_Duty = "Duty";
        public const string Field_cPerson = "cPerson";
        public const string Field_ContactType = "ContactType";
        #endregion
        ...
        public static void FillData(System.Data.DataRow dr, out t_company info)
        {
            #region
            ...
            if (dr.Table.Columns.Contains(Field_license))
                info.license = DBNull.Value == dr[Field_license] ? default(string) : (string)dr[Field_license];
            if (dr.Table.Columns.Contains(Field_registration))
                info.registration = DBNull.Value == dr[Field_registration] ? default(string) : (string)dr[Field_registration];
            if (dr.Table.Columns.Contains(Field_organization))
                info.organization = DBNull.Value == dr[Field_organization] ? default(string) : (string)dr[Field_organization];
            ...
            if (dr.Table.Columns.Contains(Field_QQWeiBo))
                info.QQWeiBo = DBNull.Value == dr[Field_QQWeiBo] ? default(string) : (string)dr[Field_QQWeiBo];
            if (dr.Table.Columns.Contains(Field_Duty))
                info.Duty = DBNull.Value == dr[Field_Duty] ? default(string) : (string)dr[Field_Duty];
            if (dr.Table.Columns.Contains(Field_cPerson))
                info.cPerson = DBNull.Value == dr[Field_cPerson] ? default(string) : (string)dr[Field_cPerson];
            if (dr.Table.Columns.Contains(Field_ContactType))
                info.ContactType = DBNull.Value == dr[Field_ContactType] ? default(string) : (string)dr[Field_ContactType];
            #endregion
