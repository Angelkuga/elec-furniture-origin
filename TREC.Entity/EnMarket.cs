...
namespace TREC.Entity
{
    ...
    public class t_market
    {
        ...
        /// 
        /// </summary>
        public const string TableName = "t_market";
        ...
        public const string Field_cbm = "cbm";
        public const string Field_lphone = "lphone";
        public const string Field_zphone = "zphone";
        public const string Field_busroute = "busroute";
        public const string Field_hours = "hours";
        ...
        public const string Field_MarketCliqueName = "MarketCliqueName";
        public const string Field_Stitle = "Stitle";
        #endregion
        ...
        public static void FillData(System.Data.DataRow dr, out t_market info)
        {
            #region
            ...
            if (dr.Table.Columns.Contains(Field_cbm))
                info.cbm = DBNull.Value == dr[Field_cbm] ? default(decimal) : (decimal)dr[Field_cbm];
            if (dr.Table.Columns.Contains(Field_lphone))
                info.lphone = DBNull.Value == dr[Field_lphone] ? default(string) : (string)dr[Field_lphone];
            if (dr.Table.Columns.Contains(Field_zphone))
                info.zphone = DBNull.Value == dr[Field_zphone] ? default(string) : (string)dr[Field_zphone];
            if (dr.Table.Columns.Contains(Field_busroute))
                info.busroute = DBNull.Value == dr[Field_busroute] ? default(string) : (string)dr[Field_busroute];
            if (dr.Table.Columns.Contains(Field_hours))
                info.hours = DBNull.Value == dr[Field_hours] ? default(string) : (string)dr[Field_hours];
            ...
            if (dr.Table.Columns.Contains(Field_MarketCliqueName))
                info.MarketCliqueName = DBNull.Value == dr[Field_MarketCliqueName] ? default(string) : (string)dr[Field_MarketCliqueName];
            if (dr.Table.Columns.Contains(Field_Stitle))
                info.Stitle = DBNull.Value == dr[Field_Stitle] ? default(string) : (string)dr[Field_Stitle];
