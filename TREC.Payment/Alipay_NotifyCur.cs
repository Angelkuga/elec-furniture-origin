   ...
   public class Alipay_NotifyCur
    {
        ...
        string subject = "家具快搜在线支付";                              //商品名称，也可称为订单名称，该接口并不是单一的只能买一样东西，可把一次支付当作一次下订单
        string body = "家具快搜在线支付。";                               //商品描述，即备注

        //支付宝消息验证地址
        private string Https_veryfy_url = "https://mapi.alipay.com/gateway.do?service=notify_verify&";

        //产品订单支付
        public string ShowAliPay(string ordercode, string TotalMoney, string extra_common_param)
        {
            //业务参数赋值；
           ...
           // "extra_common_param="+extra_common_param
            ...
            //以下是POST方式传递参数
            sb.Append("<form name='alipaysubmit' method='post' action='https://mapi.alipay.com/gateway.do?_input_charset=utf-8' target='_blank'>");
