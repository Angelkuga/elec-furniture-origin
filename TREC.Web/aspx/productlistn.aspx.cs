...
namespace TREC.Web.aspx
{
    ...
    public partial class productlistn : WebPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                strb.Append("<dl>");
                strb.Append("<dt><a href='" + item.linkurl + "'> <img src='" + item.imgurl + "' width='159' height='106' alt='' /></a></dt>");
                strb.Append("<dd>");
                strb.Append("<a href='" + item.linkurl + "'>" + item.title + "</a><br>");
                strb.Append("促销价：<span>￥" + item.price + "</span><br>");
           ...
           // strbrand.Append("</td>");
            ...
            strbrand.Append("</div>");
            strbrand.Append("<div id='divmarket' style='display:none;width:800px;'>");
            //显示剩下的内容
