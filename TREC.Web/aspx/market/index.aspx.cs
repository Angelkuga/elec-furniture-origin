...
namespace TREC.Web.aspx.market
{
    ...
    public partial class index : MarketPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region 场馆数据展示
           // 
            List<t_Pavilion> Listcg=new List<t_Pavilion>();
            Listcg=EntityOper.t_Pavilion.Where(p=>p.MarketId==marketInfo.id).ToList();

            Repeater_cg.DataSource = Listcg;
            Repeater_cg.DataBind();
            if (Listcg.Count > 0)
            {
                cgdisplay = "display:block;";
                lcdisplay = "display:none;";
            }
            else
            {
                cgdisplay = "display:none;";
                lcdisplay = "display:block;";
            }
            #endregion
        }
        ...
        protected global::System.Web.UI.WebControls.Repeater Repeater_cg;
