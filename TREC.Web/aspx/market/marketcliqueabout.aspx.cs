...
namespace TREC.Web.aspx.market
{
    ...
    public partial class marketcliqueabout : MarketCliquePageBase
    {
        public int Clique
        {
            get
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    pageTitle = "-" + _marketcliquemodel.Title + "-卖场集团介绍";

                   
                    int pc = 0;
                   // _marketlist = ECMarket.GetWebMarketList(1, 300, " and stitle='" + _marketcliquemodel.Title + "' ", "hits", "desc", out pc);
                    ...
                    //}
                    //_promotion = dpromotions.Linq.Where(c => c.auditstatus == 1 && c.linestatus == 1 && (midlist.ToArray()).Contains(c.mid)).OrderByDescending(c => c.id).ToArray();
