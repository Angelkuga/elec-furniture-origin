...
namespace TREC.Web.aspx.shop
{
    ...
    public partial class product : ShopPageBase
    {
        /// <summary>
        /// 下一页连接
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #endregion
            string strwhere_p = strWhere + " and   (shopid=0 OR shopid IS NULL) ";
            strWhere = strWhere + " and shopid=" + ECommon.QuerySId;
