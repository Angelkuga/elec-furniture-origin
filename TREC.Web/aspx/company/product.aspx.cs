...
namespace TREC.Web.aspx.company
{
    ...
    public partial class product : CompanyPageBase
    {
        /// <summary>
        /// 下一页连接
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _list = ECProduct.GetProductSearchItemByCompanyIdNew2(Utils.GetIntForString(ECommon.QueryCId), "", "").Where(x => x.type == "brand").ToList();
            ...
            AspNetPager1.UrlRewritePattern = string.Format(EnUrls.CompanyInfoProductListBrands, ECommon.QueryCId, strqsb, ECommon.QuerySearchStyle, ECommon.QuerySearchMaterial, ECommon.QuerySearchSpread, ECommon.QuerySearchColor, ECommon.QuerySearchSort, ECommon.QuerySearchComposing, ECommon.QuerySearchKey, "{0}", ECommon.QuerySearchType, ECommon.QuerySearchPCategory, ECommon.QuerySearchCategory, ECommon.QuerySearchPostName, brandids);
            pageTitle = "-产品";
