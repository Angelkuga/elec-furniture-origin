                ...
                if (the.value != "") {
                    ...
                    $.get(opt.url, { key: the.value, type: (opt.paramTypeSelector != '' ? $(opt.paramTypeSelector).attr('title') : "") ,time:new Date().toString()}, function (serverdata) {
                        ...
                        $.each(data, function (i) {                                        
                            var li = $('<li  style="padding:2px 0px 2px 5px; height:16px; line-height:16px; cursor:pointer;overflow:hidden;position:relative;">' + this.title + '</li>');
                             li.bind('click', function () {                                                                                       
                                $("#"+the.id+"").val($(this).text());                                
                            });
//                            li.data('value', this.title);                            
//                            li.data('data', this);
//                            alert(this);
//                            li.bind('click', function () {
//                                                        
