...
namespace TREC.Web.Suppler.dealer
{
    public partial class dealerinfo : SupplerPageBase
    {
        ...
        protected void ShowData()
        {
                ...
                if (model != null)
                {
                    ...
                    this.txtaddress.Text =model.address.Replace(" ","").Replace(TREC.ECommerce.ECommon.getAreaAll(model.areacode),"") ;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int myId = 0;
            int.TryParse(Request.Params["ddlstaffsize"],out myId);
            int staffsize = myId;// TypeConverter.StrToInt(Request.Params["ddlstaffsize"].ToString());
            ...
            if (aid > 0)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "click", "alert('编辑成功！');location.href='dealerinfo.aspx';", true);
