<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createbrand.aspx.cs" Inherits="TREC.Web.Suppler.f_dealer.createbrand" %>
...
<form id="form1" runat="server">
            <table class="formTable" style="display:none;">
                ...
                <tr>
                    <td align="right" width="70">厂商名称：</td>
                    <td><asp:TextBox ID="txtcompanytitless" runat="server" CssClass="input required"></asp:TextBox>
                        <div id="txtcompanysstitleTip"  style="width:280px; float:left" class="forTip" ></div> 
                    </td>
                </tr>
                <tr>
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtbrandtitle" runat="server" CssClass="input required"></asp:TextBox>
                        <div id="txtbrandtitleTip"  style="width:280px; float:left" class="forTip" ></div> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="fileUpload" path="<%=string.Format(TREC.Entity.EnFilePath.Brand, ECommon.QueryId, TREC.Entity.EnFilePath.Logo)%>">
                            ...
                            </div> <label>(请上传品牌的标志/商标/logo，尺寸为：宽196 * 高70像素)</label>
                        </div>
                ...
                <tr>
                    <td align="right" valign="top" >
                        品牌缩略图：<a href="javascript:;" class="helper" title="点击查看图片位置示意"><img src="../images/d8.gif"/></a>
                    </td>
                    <td>
                        <div class="fileUpload" path="<%=string.Format(TREC.Entity.EnFilePath.Brand, ECommon.QueryId, TREC.Entity.EnFilePath.Thumb)%>">
                            ...
                            <div class="fileTools" style="width:310px;">
                                ...
                                <span class="uploading">上传中</span>
                            </div><label>(请上传品牌的缩略图，高550×410像素)</label>
                        </div>
                    </td>
                </tr>
                 <tr>
