<%@ Page Title="" Language="C#" MasterPageFile="../Member.Master" AutoEventWireup="true" CodeBehind="marketminList.aspx.cs" Inherits="TREC.Web.Suppler.market.marketminList" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <%#Opertxt(Eval("auditstatus").ToString(), Eval("createmid").ToString(), Eval("Id").ToString())%>      
            </td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
