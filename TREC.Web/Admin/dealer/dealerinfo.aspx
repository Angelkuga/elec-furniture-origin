<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dealerinfo.aspx.cs" Inherits="TREC.Web.Admin.dealer.dealerinfo"
        ...
        $(function () {
            ...
            KindEditor.ready(function (K) {
                editor = K.create('#txtdescript', {
                    ...
                    { %>
                     fileManagerJson:"<%=TREC.ECommerce.ECommon.WebAdminResourceUrl %>/editor/kindeditor/ashx/file_manager_json.ashx?m=dealer&id=<%=TREC.ECommerce.ECommon.QueryId %>",
                    <%} %>
...
<body style="padding: 10px;">
    ...
    <div class="navigation">
        <span class="back"><a href="dealerlist.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 成员管理 &gt;
            登陆账号管理</b>
    </div>
    <div class="spClear">
    </div>
            ...
            <td width="390px" valign="top">
                ...
                <table class="formTable" width="380px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddldealergroup" runat="server" CssClass="select selectNone"
                                Width="160px">
                            </asp:DropDownList>
                        </td>
                    </tr>
