<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newslist.aspx.cs" Inherits="TREC.Web.Admin.information.newslist" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
        <span class="add"><a href="newsinfo.aspx">添加信息</a></span><b>您当前的位置：首页 &gt; 促销信息模块 &gt;
            行业资讯信息</b>
    </div>
    <div class="spClear">
    </div>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="newsinfo.aspx?id=<%#Eval("id") %>">
                            <%#Eval("title") %></a>
                    </td>
                    <td align="center">
                       <%#dnews.LinqData<Mmember>().Where(c => c.id == Convert.ToInt32(Eval("mid"))).Select(c => c.username).FirstOrDefault()%>
                    </td>
