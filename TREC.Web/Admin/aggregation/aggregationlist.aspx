<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aggregationlist.aspx.cs" Inherits="TREC.Web.Admin.aggregation.aggregationlist" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <th align="center" width="160px">最后修改时间</th>
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <td align="left"><a href="aggregationinfo.aspx?edit=1&id=<%#Eval("id") %>"><%#Eval("title") %></a></td>
            <td align="center"><%#Eval("lastedittime")%></td>
            <td align="right" style="padding-left:5px;"><a href="aggregationinfo.aspx?edit=1&id=<%#Eval("id") %>">修改</a><%--|<a href="aggregationlist.aspx?edit=2&id=<%#Eval("id") %>">删除</a>--%></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
