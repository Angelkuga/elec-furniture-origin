<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aggregationtypeinfo.aspx.cs" Inherits="TREC.Web.Admin.aggregation.aggregationtypeinfo" %>
...
<form id="form1" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">聚合信息模块</th>
        </tr>
        <tr>
            ...
            <td  align="left">
                <asp:DropDownList ID="ddlparent" runat="server" CssClass="select"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td  align="right">
        ...
        <tr>
            ...
            <td  align="left">
                <asp:TextBox ID="txtthumb" runat="server" CssClass="input"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td  align="right">
