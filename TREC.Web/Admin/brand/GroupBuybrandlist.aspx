<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupBuybrandlist.aspx.cs" Inherits="TREC.Web.Admin.brand.GroupBuybrandlist" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="right" style="padding-left: 5px;">
                        <a href="GroupBuyInfor.aspx?id=<%#Eval("id") %>">修改</a><%--|<a href="brandlist.aspx?edit=2&id=<%#Eval("id") %>">删除</a>--%></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
    </table>
