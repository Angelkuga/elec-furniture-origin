...
namespace TREC.Web.Admin.brand
{
    public partial class brandslist : AdminPageBase
    {
        ...
        protected void ShowData()
        {
            ...
            string strWhere = " 1=1 ";
            //工厂名称
            if (!string.IsNullOrEmpty(txtBrandsTitle.Text.Trim()))
            {
                strWhere += " and title like '%" + txtBrandsTitle.Text.Trim() + "%'";
            }
            //品牌名称
            ...
            //rptList.DataSource = ECBrand.GetAdminBrandsList(ECommon.QueryPageIndex, AspNetPager1.PageSize, strWhere, out tmpPageCount);
            rptList.DataSource = ECBrand.GetAdminBrandsList(AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, strWhere, out tmpPageCount);
            rptList.DataBind();
