<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="promotionlist.aspx.cs" Inherits="TREC.Web.Admin.promotion.promotionlist" %>
...
<div class="navigation">
    <span class="add"><a href="promotioninfo.aspx">添加信息</a></span><b>您当前的位置：首页 &gt; 促销活动 &gt; 促销活动信息</b>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <th width="80px" align="center">范围管理</th>
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <td align="center"><a href="promotiondefinfo.aspx?pid=<%#Eval("id") %>">添加</a>/<a href="promotiondeflist.aspx?pid=<%#Eval("id") %>">管理</a></td>
            <td align="left"><a href="promotioninfo.aspx?edit=1&id=<%#Eval("id") %>"><%#Eval("title") %></a></td>
            <td align="center"><%#Eval("lastedittime")%></td>
            <td align="right" style="padding-left:5px;"><a href="promotioninfo.aspx?edit=1&id=<%#Eval("id") %>">修改</a>|<a href="promotionlist.aspx?edit=2&id=<%#Eval("id") %>">删除</a></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
