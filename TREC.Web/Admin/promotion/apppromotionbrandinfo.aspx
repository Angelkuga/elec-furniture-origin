<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="apppromotionbrandinfo.aspx.cs"
    Inherits="TREC.Web.Admin.promotion.apppromotionbrandinfo" %>
...
<body style="padding: 10px;">
    ...
    <div class="navigation">
        <span class="back"><a href="apppromotionbrandlist.aspx">返回列表</a></span><b>您当前的位置：首页
            &gt; 促销活动 &gt; 促销活动信息</b>
    </div>
    <div class="spClear">
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <div class="fileUpload" path="<%=string.Format(TREC.Entity.EnFilePath.AppPromotionBrand, ECommon.QueryId, TREC.Entity.EnFilePath.Thumb)%>">
        ...
        <tr>
            ...
            <td>
                <div class="fileUpload m" path="<%=string.Format(TREC.Entity.EnFilePath.AppPromotionBrand, ECommon.QueryId, TREC.Entity.EnFilePath.Banner)%>">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txthtmltitle" runat="server" CssClass="input"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtBrandABC" runat="server" CssClass="input"></asp:TextBox>必须和福家网一样
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:CheckBox runat="server" ID="ckIsRecommend" />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtdescript" TextMode="MultiLine" Width="500" Height="200px" runat="server"
                    CssClass="input w160"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtrulesInfo" runat="server" CssClass="input" TextMode="MultiLine"
                    Rows="8" Height="200" Width="500"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txttemplate" runat="server" CssClass="input" TextMode="MultiLine"
                    Rows="8" Height="200" Width="500"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtstarttime" runat="server" CssClass="input Wdate w160 required"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtendtime" runat="server" CssClass="input Wdate w160 required" onfocus="WdatePicker()"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtpercount" runat="server" CssClass="input" Width="40">0</asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtdiscount" runat="server" CssClass="input" Width="40">0</asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="txtperiod" runat="server" CssClass="input" Width="40"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtappcount" runat="server" CssClass="input" Width="40">0</asp:TextBox>
            </td>
        </tr>
    </table>
