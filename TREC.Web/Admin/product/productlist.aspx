...
<body style="padding: 10px;">
    ...
    <div class="navigation">
        <span class="add"><a href="productinfo.aspx">添加系列</a></span><b>您当前的位置：首页 &gt; 产品管理 &gt;
            产品管理</b>
    </div>
    <div class="spClear">
    </div>
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlproductbigcategory" runat="server">
                </asp:DropDownList>
            </td>
            <td>
                分类：
        ...
        <asp:Repeater ID="rptList" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td align="left">
                        <a href="productinfo.aspx?edit=1&id=<%#Eval("id") %>" title="<%#Eval("HtmlProductName")%>">
                            <%#Eval("title")%></a>
                    </td>
                    <td align="center">
                        <%#Eval("brandtitle")%>
                    ...
                    <td align="right" style="padding-left: 5px;">
                        <a href="productinfo.aspx?edit=1&id=<%#Eval("id") %>" target="_blank">修改</a><%--|<a href="productlist.aspx?edit=2&id=<%#Eval("id") %>"
