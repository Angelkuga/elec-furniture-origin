<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modulelist.aspx.cs" Inherits="TREC.Web.Admin.permission.modulelist" %>
...
<div class="navigation">
    <span class="add"><a href="moduleinfo.aspx">添加系列</a></span><b>您当前的位置：首页 &gt; 系统管理 &gt; 模块管理</b>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <td align="left"><a href="moduleinfo.aspx?edit=1&id=<%#Eval("id") %>"><%#Eval("title") %></a></td>
            <td align="center"><asp:TextBox ID="txtSort" runat="server" Text='<%#Eval("sort") %>' Width="40" style="margin-left:10px;"></asp:TextBox></td>
            <td align="right" style="padding-left:5px;"><a href="moduleinfo.aspx?edit=1&id=<%#Eval("id") %>">修改</a>|<a href="modulelist.aspx?edit=2&id=<%#Eval("id") %>">删除</a></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
