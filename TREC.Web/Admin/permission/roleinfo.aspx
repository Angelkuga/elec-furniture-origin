<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="roleinfo.aspx.cs" Inherits="TREC.Web.Admin.permission.roleinfo" %>
...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="rolelist.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 系统管理 &gt; 角色信息</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">角色信息</th>
        </tr>
        <tr>
	        <td width="160px" align="right">角色标题：</td>
	        <td align="left">
