<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="actioninfo.aspx.cs" Inherits="TREC.Web.Admin.permission.actioninfo" %>
...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="actionlist.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 系统管理 &gt; 操作权限</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">操作权限</th>
        </tr>
        <tr>
	        <td width="160px" align="right">操作名称：</td>
	        <td align="left">
		        <asp:TextBox id="txttitle" runat="server" CssClass="input"></asp:TextBox>
	        </td>
        </tr>
	    <tr>
	        <td align="right">操作标识：</td>
	        <td align="left">
        ...
        <tr>
	        ...
	        <td align="left">
		        <asp:DropDownList ID="ddlMoudle" runat="server"></asp:DropDownList>
	        </td>
       </tr>
        <tr>
            <td align="right">操作类型：</td>
	        <td align="left">
		        <asp:RadioButtonList ID="raActionType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"></asp:RadioButtonList>
	        </td>
       </tr>
	    <tr>
