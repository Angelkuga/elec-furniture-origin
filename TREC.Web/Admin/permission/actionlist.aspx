<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="actionlist.aspx.cs" Inherits="TREC.Web.Admin.permission.actionlist" %>
...
<div class="navigation">
    <span class="add"><a href="actioninfo.aspx">添加系列</a></span><b>您当前的位置：首页 &gt; 系统管理 &gt; 操作权限</b>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <th align="center"  width="120">所属模块</th>
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <td align="center"><%#Eval("mid") %></td>
            <td align="left"><a href="actioninfo.aspx?edit=1&id=<%#Eval("id") %>"><%#Eval("title") %></a></td>
            <td align="right" style="padding-left:5px;"><a href="actioninfo.aspx?edit=1&id=<%#Eval("id") %>">修改</a>|<a href="actioninfo.aspx?edit=2&id=<%#Eval("id") %>">删除</a></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
