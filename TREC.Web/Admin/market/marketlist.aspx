...
<body style="padding: 10px;">
    ...
    <div class="navigation">
        <span class="add"><a href="marketinfo.aspx">添加系列</a></span><b>您当前的位置：首页 &gt; 成员管理 &gt;
            登陆账号管理</b>
    </div>
    <div class="spClear">
    </div>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td align="left">
                        <a href="marketinfo.aspx?edit=1&id=<%#Eval("id") %>">
                            <%#Eval("title") %></a>
                    </td>
                    <td align="center">
                        <%#GetBrandCount(Eval("id"))%>
                    </td>
                    <td align="center">
                        <%#Eval("cbm")%>平米
                    </td>
                    ...
                    <td align="right" style="padding-left: 5px;">
                        <a href="marketinfo.aspx?edit=1&id=<%#Eval("id") %>" target="_blank">修改</a><%--|<a href="marketlist.aspx?edit=2&id=<%#Eval("id") %>">删除</a>--%>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
