<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="administratorlist.aspx.cs" Inherits="TREC.Web.Admin.administrator.administratorlist" %>
...
<div class="navigation">
    <span class="add"><a href="administratorinfo.aspx">添加系列</a></span><b>您当前的位置：首页 &gt; 系统管理 &gt; 管理员管理</b>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <asp:Repeater ID="rptList" runat="server">
        <ItemTemplate>
            ...
            <td align="left"><a href="administratorinfo.aspx?edit=1&id=<%#Eval("id") %>"><%#Eval("name") %></a></td>
            <td align="center"><%#Eval("email") %></td>
            <td align="center"><%#Eval("lastactivitydate")%></td>
            <td align="right" style="padding-left:5px;"><a href="administratorinfo.aspx?edit=1&id=<%#Eval("id") %>">修改</a>|<a href="administratorlist.aspx?edit=2&id=<%#Eval("id") %>">删除</a></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>
