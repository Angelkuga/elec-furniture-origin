<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pavilionAbout.aspx.cs" Inherits="TREC.Web.template.web.market.pavilionAbout" %>
    ...
    <div class="marketdesc">
        <div class="topNav992">
            <div class="homebraLift" style="width: 950px; ">
                ...
                <div class="homebraLi2" style="display:none;">
                    <h3>
                        联系方式</h3>
