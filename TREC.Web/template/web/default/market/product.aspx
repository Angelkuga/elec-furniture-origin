            ...
            <div class="productList1">
                ...
                <div class="productList">
                                ...
                                <%
                                    ...
                                    {
                                        listcount++;  %>
                                <div class="sycpp" style="height:302px;">
                                    ...
                                    <div class="sycpp4">
                                     ...
                                     <div class="sycpp4"  style="color:#e00000;">
                                   
                                        <% if (TREC.ECommerce.SubmitMeth.getdouble(p.ProductAttributeInfo.buyprice) > 0)
                                           {%>
                                            <%=ECProduct.CheckbuypriceName(p.id.ToString())%>：<span>¥<%=p.ProductAttributeInfo.buyprice%></span>
                                            <%} %>
                                            </div>
                                    ...
                                    <div class="sycpp5">
                                        <a href="<%=string.Format(EnUrls.ShopInfoIndex, p.ProductShopInfo.id)%>" target="_blank">
                                            <%=getShopTitle(p.ProductShopInfoBymarket)%></a>
                                            
                                            </div>
                                           <div style="padding-top:5px;">
                                            <%=getShopPosition(p.ProductShopInfoBymarket[0].id)%></div>
                                    <%}
                                      else
                                      {%>
                                    <div class="sycpp5">
                                ...
                                <webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="false" CurrentPageButtonClass="cpb"
                                    ...
                                    PrevPageText="上一页" ShowPageIndexBox="Never" PageSize="48">
