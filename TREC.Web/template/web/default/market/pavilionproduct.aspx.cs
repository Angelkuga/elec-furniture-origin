...
namespace TREC.Web.template.web.market
{
    ...
    public partial class pavilionproduct : MarketPageBase
	{
        /// <summary>
        /// 下一页连接
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strWhere = " and brandid IN(  SELECT CONVERT(INT, brandidlist) FROM t_MarketStoreyShop WHERE marketid=" + marketInfo.id + " AND pavilionid=" + paid + " ) ";
