...
<body>
    <uc4:_headA ID="_headA1" runat="server" />
    <!--main-->
    ...
    <!--标签切换begin-->
    <div class="cpTitle"><ul><li id="one1" class="tabActive">申请入驻</li><li id="one2" class="tabNormal">供应商登录</li></ul></div>
	    <div class="cplist" id="con_one_1" style="DISPLAY: block;">
            <table width="250" border="0" cellspacing="0" cellpadding="0"> 
                ...
                <tr><td height="33">验&nbsp;证&nbsp;码：</td><td align="left"><img id="imgValiateCode" src="<%=TREC.ECommerce.ECommon.WebUrl %>/ajaxtools/imageVerify.aspx?model=reg"><input id="txtValidation" maxlength="4" type="text"  class="textfiled2" /><a class="xieyi" id="chkImgVerify">换一张</a></td></tr>
        ...
        <div class="cplist" id="con_one_2" style="DISPLAY: none;">
            <table width="250" border="0" cellspacing="0" cellpadding="0">               
                ...
                <a href="seekusermail.aspx" target="_blank" class="huan" title="邮件找密码？">邮件找密码？</a>
                </td></tr>                
            </table>
        </div>
    </div>
...
<div class="menubg">
<div align="center">
<div class="mainmenu"><ul><li><a href="#a01">为什么要加入我们？</a></li><li><a href="#a03">我们做什么？</a></li><li><a href="#a02">入驻流程</a></li><li><a href="#a04">收费标准</a></li><li><a href="#a05">会员特权</a></li><li><a href="#a06">如何发布信息？</a></li><li><a href="#a07">组织团购</a></li></ul></div>
</div>
</div>
</div>
<!-- main begin --->
...
<div class="clear"></div></div>
<div class="content">
<h1 class="banner"><a name="a04"></a><img src="<%=TREC.ECommerce.ECommon.WebResourceUrl %>web/images/newreg/sjrz_54.jpg" alt="收费标准" width="865" height="43" /></h1>
<div class="biaozhun">
    ...
    <table width="865" border="0" align="center" cellpadding="0" cellspacing="1" widtd="940" >
        ...
        <tr><td class="bg02">店铺在线客服坐席</td><td class="bg02">1000元/坐席/年</td><td rowspan="3" class="bg02">&nbsp;</td></tr>
        <tr class="bg02"><td class="bg03">网络推广营销</td><td class="bg03">20000元/品牌</td></tr>
        <tr class="bg02"><td class="bg03">首页横幅广告</td><td class="bg03">1000元/周</td></tr>
        <tr><td class="bg02">首页产品推荐</td><td class="bg02">200元/周</td><td rowspan="4" class="bg02">活动期间任选一个赠送1个月<br />（仅限20个名额）</td></tr>
        <tr class="bg02"><td class="bg03">首页品牌推荐</td><td class="bg03">200元/周</td></tr>
        <tr class="bg02"><td class="bg03">首页工厂推荐</td><td class="bg03">200元/周</td></tr>
        <tr class="bg02"><td class="bg03">首页店铺推荐</td><td class="bg03">200元/周</td></tr>
    </table>
</div>
...
<tr class="bg01"><td width="290">基本功能项目明细</td><td width="282">非付费用户</td><td width="279">付费用户</td></tr>
...
<tr><td class="bg02">发布产品信息</td><td class="bg02"><img src="<%=TREC.ECommerce.ECommon.WebResourceUrl %>web/images/newreg/checkmark.png" width="16" height="16" /></td><td class="bg02"><img src="<%=TREC.ECommerce.ECommon.WebResourceUrl %>web/images/newreg/checkmark.png" width="16" height="16" /></td></tr>
...
<tr><td class="bg02">发布店铺信息</td><td class="bg02"><img src="<%=TREC.ECommerce.ECommon.WebResourceUrl %>web/images/newreg/delete.png" width="16" height="16" /></td><td class="bg02"><img src="<%=TREC.ECommerce.ECommon.WebResourceUrl %>web/images/newreg/checkmark.png" width="16" height="16" /></td></tr>
...
<table width="865" border="0" align="center" cellpadding="0" cellspacing="1" class="reg-table4">
    <tr><td width="291" class="bg01">增值服务项目明细</td><td width="564" class="bg01">说明</td></tr>
    <tr><td class="bg02">商家店铺在线客服坐席</td><td class="bg02">专业客服人员热诚接待</td></tr>
    <tr><td class="bg02">商家在线成交</td><td class="bg02">此功能近期将推出</td></tr>
    <tr><td class="bg02">家具快搜黄页/杂志期刊</td><td class="bg02">定期的潮流品牌家居资讯</td></tr>
    <tr><td class="bg02">商家网络营销包装推广</td><td class="bg02">热门论坛、博客的推广发布</td></tr>
    <tr><td class="bg02">商家全国客服咨询中心</td><td class="bg02">400-001-9211</td></tr>
    <tr><td rowspan="14" class="bg02">站内广告和店铺包装</td><td class="bg02">首页横幅广告</td></tr>
    <tr><td class="bg02">首页产品推荐</td></tr>
    <tr><td class="bg02">首页品牌推荐</td></tr>
    <tr><td class="bg02">首页工厂推荐</td></tr>
    <tr><td class="bg02">首页卖场推荐</td></tr>
    <tr><td class="bg02">首页店铺推荐</td></tr>
    <tr><td class="bg02">内页右侧推荐（不限推荐类型）</td></tr>
    <tr><td class="bg02">产品详细页右侧店铺推荐</td></tr>
    <tr><td class="bg02">产品图片拍摄处理</td></tr>
    <tr><td class="bg02">子页面包装上线（不含产品)</td></tr>
    <tr><td class="bg02">增加个性域名</td></tr>
    <tr><td class="bg02">招商栏目招商信息置顶</td></tr>
    <tr><td class="bg02">招商信息策划设计上线</td></tr>
    <tr><td class="bg02">促销栏目促销信息置顶</td></tr>
  </table>
</div>
</div>
<div class="content">
...
<uc5:_foot ID="_foot1" runat="server" />
</body>
</html>