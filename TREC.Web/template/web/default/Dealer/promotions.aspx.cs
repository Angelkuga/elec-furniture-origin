...
{
    public partial class promotions : DealerPageBase
	{
        ...
        void showData()
        {
            ...
            var query = dpromotions.Linq.Where(c => c.auditstatus == 1 && c.attribute == "促销" && c.mid == mid && c.linestatus == 1 && (c.membertype == (int)EnumMemberType.工厂企业 || c.membertype == (int)EnumMemberType.经销商)).GroupJoin(dpromotions.LinqData<Mpromotionsrelated>(), c => c.id, c => c.promotionsid, (f, k) => new { f, k });
