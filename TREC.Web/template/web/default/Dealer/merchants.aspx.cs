...
{
    public partial class merchants : DealerPageBase
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
               // Response.Redirect(string.Format(EnUrls.DealerInfoMerchantsSearch, did, "0", "0", 1));
            }
        ...
        void showData()
        {
            ...
            var query = dpromotions.Linq.Where(c => c.auditstatus == 1 && c.linestatus == 1 &&c.mid==mid&&c.attribute=="招商"&& (c.membertype == (int)EnumMemberType.工厂企业 || c.membertype == (int)EnumMemberType.经销商)).GroupJoin(dpromotions.LinqData<Mpromotionsrelated>(), c => c.id, c => c.promotionsid, (f, k) => new { f, k });
