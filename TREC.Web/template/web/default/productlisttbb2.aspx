<%@ Page Language="C#" AutoEventWireup="true" Inherits="TREC.Web.aspx.productlisttbb2"
    CodeBehind="productlisttbb2.aspx.cs" %>
...
<body>
    ...
    <div class="main clearfix">
        ...
        <div class="listy">
            ...
            <ul class="listy33 clearfix" id='ulinfo'>
                <%--<li>
                    <div class="tbbxl">
                        <a href="#">
    ...
    <script>
        ...
        $.each($("#con_one_1 a"), function (i, link) {
            ...
            if ($(this).html().replace(/ /g, "").indexOf("套组合") == -1 && $(this).attr("t") != "d") {
                link.href = link.href.replace('productlist', 'productlisttbb');
            }
        ...
        function hd(index) {
            ...
            $.ajax({
                ...
                url: '../../../ajax/hdsearch.ashx?t=tzhl&pg=' + pagesize + '&pi=' + index + '&cx=&fg=' + $("#hidfg").val() + '&cz=' + $("#hidcz").val() + '&ys=' + $("#hidys").val() + '&pp=' + $("#hidpp").val() + '&type=' + $("#hidtype").val() + '&m=' + Math.random(),
                type: 'post', //post方法
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.dt.length; i++) {
                        ...
                        s += "<li>";
                        s += "<div class='tbbxl'>";
                        s += "<a href='<%=TREC.ECommerce.ECommon.WebUrl %>/productinfotzh.aspx?tid=" + data.dt[i].gpId + "'>";
                        s += "<div class='tpm'><img src='<%=TREC.ECommerce.ECommon.WebUrl %>/upload/productgroup/thumb/" + data.dt[i].gpId + "/" + imgfilename + "' alt='' /></div>";
                        // s += "<img src='/resource/content/images/11.jpg' width='222' height='166' alt='' />";

                        s += "</a><br>";
                        s += "<a href='<%=TREC.ECommerce.ECommon.WebUrl %>/productinfotzh.aspx?tid=" + data.dt[i].gpId + "' title='" + titlenames + "'>" + titlenamesub + "</a><br>";
                        s += "<span>¥" + data.dt[i].price + " </span><span class='tbbx2' style='display:none'>| 销量：</span><br />";
                        ...
                        s += "<img src='resource/content/img/index/common6.gif'  class='fdd' width='58' height='58'  />";
                        s += "</div>";
                        s += "</li>";
                    }
        ...
        $.ajax({
            async: false, //是否异步
            url: '../../../ajax/hdsearch.ashx?t=tjtzh&did=' + $("#hidtype").val() + '&xid=' + $("#hidxl").val() + '&ty=3&p=0&c=8&m=' + Math.random(),
            type: 'post', //post方法
            dataType: 'json', //返回json格式数据
            success: function (data) {
