 ...
 <uc1:header ID="header1" runat="server" />
    <div class="brand-mod w clearfix">
        ...
        <table>
            <tr>
                <td>
                    <div class="cont-r fr" style="width: 230px;">
    ...
    <script type="text/javascript">
       ...
       hd(1);
        function hd(index) {
            ...
            $.ajax({
                async: true, //是否异步
                url: '../../../ajax/hdsearch.ashx?t=pp&pi=' + index + '&pg=' + pagesize + '&mc=' + $("#hidmc").val() + '&cz=' + $("#hidcz").val() + '&fg=' + $("#hidfg").val() + '&k=' + escape($("#hidkey").val()) + '&m=' + Math.random(),
                type: 'post', //post方法
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.dt.length; i++) {
                        ...
                        s += " <img src=\"<%=TREC.ECommerce.ECommon.WebUrl %>/upload/brand/thumb/" + data.dt[i].id + "/" + data.dt[i].thumb.replace(",", "") + "\" width=\"215\" height=\"105\"  alt=''/></div>";

                        s += "<div class=\"pplm22\"><dd class=\"dd1\">" + data.dt[i].title + "</dd><dd class=\"dd2\">";
