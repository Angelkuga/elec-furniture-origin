...
<head id="Head1" runat="server">
   <uc6:_companykeys ID="_companykeys1" Title="-招商信息" runat="server" />
                    ...
                    <div class="brandjs">
                        <div class="brandjs1">
                          <ul class="ul1" id="brandNav">
                            ...
                            <span class="s1" style="margin-left:10;">招商信息</span>
                            <span class="s1" style="margin-left:0;display:none;" >&nbsp;<my:AreaSelect ID="txtarea" runat="server" /><input id="btnareasearch" type="button" value="搜索" /></span>
