...
<div class="topNav992 logo">
    ...
    <div class="logo-s r">
        <div class="logo-s-t" id="searchTypeList">
            <a id="T_product" title="product" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("searchtype", "product", "", "Searcha")%><%=TREC.ECommerce.UiCommon.QueryStringCur("searchtype", "", "", "Searcha")%>">搜产品</a>
            <a id="T_brand" title="brand" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("searchtype", "brand", "", "Searcha")%>">搜品牌</a>
            <a id="T_market" title="market" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("searchtype", "market", "", "Searcha")%>">搜卖场</a>
        </div>
        ...
        <script type="text/javascript">
            ...
            //                  { $("#searchKey").val("床"); }
            //                  else if (obj == "m")
            //                  { $("#searchKey").val("红星美凯龙汶水店"); }
            //              }
            $(function () {
                var url = document.URL.toLowerCase();
                //                  if (url.indexOf("product".toLowerCase()) != -1) {
                //                      $("#searchKey").val("床");
                //                  }
                //                  else if (url.indexOf("market".toLowerCase()) != -1) {
                //                      $("#searchKey").val("红星美凯龙汶水店");
                //                  }
                //                  else
                //                  { $("#searchKey").val("楷模"); }
...
<%--<div class="topNav992 nav">
    <ul class="nav1">
        <li><a href="/" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","index.aspx,login.aspx,reg.aspx","","active") %>">
            首页</a></li>
        <li><a href="<%=TREC.ECommerce.ECommon.WebUrl %>/company-brand/list.aspx" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","companylist.aspx,companybrandlist.aspx","","active") %>">
            家具品牌</a></li>
        <li><a href="<%=TREC.ECommerce.ECommon.WebUrl %>/product/list.aspx" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","productlist.aspx","","active") %> <%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","productInfo.aspx","","active") %>">
            产品</a></li>
        <li><a href="http://www.fujiawang.com/tuan/index.aspx" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","marketlist.aspx","","active") %>">
            团购</a></li>
        <li><a href="http://fujiawang.com/Promotion/Promotions.aspx" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","promotions.aspx,promotionsinfo.aspx","","active") %>">
            天天特价</a></li>
        <li><a href="<%=TREC.ECommerce.ECommon.WebUrl %><%=EnUrls.NewsList %>" class="<%=UiCommon.QueryStringCur("pageName", "news.aspx,newsinfo.aspx", "", "active") %>">
            行业资讯</a></li>
    </ul>
</div>--%>
   	...
   	<div class="topNav992 nav pr">
        ...
        <!---nav-m-end-->
    	<ul class="nav1"> 
            <li><a href="/" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","index.aspx,login.aspx,reg.aspx","","active") %>">首页</a></li>
            <li><a href="<%=TREC.ECommerce.ECommon.WebUrl %>company-brand/list.aspx"  class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","companylist.aspx,companybrandlist.aspx","","active") %>">家具品牌</a></li>
           <li><a href="<%=TREC.ECommerce.ECommon.WebUrl %>market/list.aspx" class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName","marketlist.aspx","","active") %>">家具卖场</a></li>
           <li><a href="###">促销活动</a></li>
