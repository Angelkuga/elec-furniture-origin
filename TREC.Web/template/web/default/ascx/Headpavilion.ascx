<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Headpavilion.ascx.cs" Inherits="TREC.Web.template.web.ascx.Headpavilion" %>
...
<div class="header-box">
    <div class="w clearfix">
        ...
        <div class="fl search group" style="height:80px;">
...
<div class="nav">
    <div class="nav-box w clearfix">
        ...
        <ul class="nav-title fl" id="j_menuTab"> 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "index.aspx", "", "on")%>"><a class="nav-item" href="/market/PavilionIndex.aspx?mid=<%=string.Format(ECommon.QueryMid) %>&paid=<%=paid %>" >首 页</a></li>
 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "marketcliqueabout.aspx", "", "on")%>"><a class="nav-item" href="/market/pavilionAbout.aspx?mid=<%=string.Format(ECommon.QueryMid) %>&paid=<%=paid %>"  >场馆介绍</a></li>
 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "about.aspx", "", "on")%>"><a class="nav-item" href="/market/pavilionproduct.aspx?mid=<%=string.Format(ECommon.QueryMid) %>&paid=<%=paid %>">全部产品</a></li>
        </ul>
    </div>
</div>
<!--菜单结束-->  
