...
<script type="text/javascript">
    $(function () {
        ...
        $("#topSearchBtn").click(function () {
            ...
            window.location.href = "productlist.aspx?k=" + escape($("#searchKey").val());
...
<div class="header">
    <div class="hd w">
        <ul class="clearfix fl left">
            ...
            <li class="li4"><a href="javascript:addToFavorite();">收藏</a></li>
              <li class="li7">
...
<div class="nav">
    <div class="nav-box w clearfix">
        ...
        <ul class="nav-title fl" id="j_menuTab">
            ...
            <li  id='linav_2' class="nav-brand"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/companybrandlist.aspx"
                class="nav-item">品 牌</a>
                <dl>
                </dl>
            </li>
            <li  id='linav_3'><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/marketlist.aspx" class="nav-item"
...
<script>
    $("#linav_<%=nid %>").css("background-color", "#74072b");
</script>
<!--菜单结束-->
