<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header.ascx.cs" Inherits="TREC.Web.aspx.ascx.headermarket" %>
...
<div class="header-box">
    <div class="w clearfix">
        ...
        <div class="fl search group" style="height:100px;">
                <%if (!string.IsNullOrEmpty(MarketPageBase.marketInfo.logo)) { %><img class="vm"  src="<%=EnFilePath.GetMarketLogoPath(MarketPageBase.marketInfo.id.ToString(),MarketPageBase.marketInfo.logo) %>" width="105" height="38"/><%} %>                
                <%=MarketPageBase.marketInfo.title %> 
                <br />
                <span style="font-size:13px;color:#333333;"><%=address %>&nbsp;&nbsp;&nbsp;&nbsp;<%=phone%>  </span>
            </div>
        <div class="right fr">
    ...
    <div class="nav-box w clearfix">
        ...
        <div class="main-nav fl" id="j_navTab">
            ...
            <ul class="pull-down hide">
                ...
                <li class="li3"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/productlist.aspx?did=7" class="nav-item">卧室系列</a> <a href="#"
                    class="trim"></a>
                    <dl class="hide">
                        <dd>
                            <div class="item">
                ...
                <li class="li4"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/productlist.aspx?did=10" class="nav-item">餐厅系列</a><a href="#"
                    class="trim"></a><dl class="hide">
                        <dd>
                            <div class="item">
                                <div class="inner">
                                    <table border='0'>
                ...
                <li class="li5"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/productlist.aspx?did=9" class="nav-item">客厅系列</a><a href="#"
                    class="trim"></a><dl class="hide">
                        <dd>
                            <div class="item">
                                <div class="inner">
                ...
                <li class="li6"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/productlist.aspx?did=11" class="nav-item">书房系列</a><a href="#"
                    class="trim"></a><dl class="hide">
                        <dd>
                            <div class="item">
                                <div class="inner">
                ...
                <li class="li7"><a href="<%=TREC.ECommerce.ECommon.WebUrl.TrimEnd('/')%>/productlist.aspx?did=12" class="nav-item">儿童系列</a><a href="#"
                    class="trim"></a><dl class="hide">
                        <dd>
                            <div class="item">
                                <div class="inner">
        ...
        <ul class="nav-title fl" id="j_menuTab"> 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "index.aspx", "", "on")%>"><a class="nav-item" href="<%=string.Format(EnUrls.MarketInfoIndex,ECommon.QueryMid) %>" >首 页</a></li>
 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "marketcliqueabout.aspx", "", "on")%>"><a class="nav-item" href="/market/marketclique.aspx?id=<%=_marketcliqueid %>" target="_blank" >集团总部</a></li>
 
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "about.aspx", "", "on")%>"><a class="nav-item" href="<%=string.Format(EnUrls.MarketInfoAbout,ECommon.QueryMid) %>">卖场介绍</a></li>
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "product.aspx", "", "on")%>"><a class="nav-item" href="<%=string.Format(EnUrls.MarketInfoProduct,ECommon.QueryMid) %>">全部产品</a></li>
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "promotions.aspx,promotionsinfo.aspx", "", "on") %>"><a class="nav-item" href="<%=string.Format(EnUrls.MarketInfoPromotions, ECommon.QueryMid) %>" >促销活动</a></li>
            <li class="<%=TREC.ECommerce.UiCommon.QueryStringCur("pageName", "business.aspx", "", "on")%>"><a class="nav-item" href="<%=string.Format(EnUrls.MarketBusiness,ECommon.QueryMid) %>">招商信息</a></li>
        </ul>
    </div>
</div>
<!--菜单结束-->  
