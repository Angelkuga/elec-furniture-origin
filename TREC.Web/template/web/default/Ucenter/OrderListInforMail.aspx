<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderListInforMail.aspx.cs" Inherits="TREC.Web.template.web.Ucenter.OrderListInforMail" %>
...
<body>
   ...
   <uc1:header ID="header1" runat="server" />
    <div class="site"><a href="#">首页</a> &gt; <a href="#">购物车</a> &gt; 定单查看</div>
...
<div style=";width:975px;height:auto;margin-left:110px;">
...
<div class="kbody_address" style="border-bottom-width:0px;">
  <div>
  <table border="0" style="color:#555555;">
  <tr class="kbody_proct"><td style="width:80px;" align="center">商品编号</td> <td style="width:480px;" align="center">产品名称</td><td style="width:250px;" align="center">尺寸(长X宽X高)mm</td>
